...
const Home = (): ReactElement => {
    ...
    return (
        <Layout title="Kershner Endeavors">
            <Box>
                <Parallax strength={500} bgImage="/img/geometric.webp">
                                ...
                                <Card sx={SERVICE_CARD_SX}>
                                    ...
                                    <CardContent>
                                        <List>
                                            ...
                                            <ListItem>
                                                Develop strategic vision and
                                                software principles.
                                            </ListItem>
                                            <ListItem>
                                                Oversee development roadmap and
                                                provide cohesive deliverables.
                                            </ListItem>
                                            <ListItem>
                                                Improve and Monitor Software
